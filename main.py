...
def export(*args):
  ...
  inventor_csv = inventor_df.to_csv("Inventor-Specific Deltas.csv", sep='\t')
  ifs_csv = ifs_df.to_csv("IFS-Specific Deltas.csv", sep='\t')
...
ttk.Button(mainframe, text="Quick Compare", command=compare).grid(column=2, row=4, sticky=W)
